...
def index(request):
    if request.session.get('username'):
        ...
        return render(request,"myapp/home.html",context={"username":user})
...
def cast_vote(request):
    ...
    return render(request,"myapp/cast_vote.html",context={"candidates":candidates,"vote_status":v.is_voted})
